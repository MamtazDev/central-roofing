          ...
          <div className="row align-items-center">
            <div className="col-xl-7 col-lg-6 order-0 order-lg-2">
              <div className="about-img-wrap">
                <img
                  ...
                  src="/assets/img/images/new1.PNG"
                  alt=""
                  width={369}
                  height={500}
                ...
                <img
                  ...
                  src="/assets/img/images/new2.PNG"
                  alt=""
                  width={243}
                  height={475}
                  className="wow fadeInRight"
            ...
            <div className="col-xl-5 col-lg-6">
              <div className="about-content">
                ...
                <p>
                  Central Roofing Systems is dedicated to delivering exceptional
                  roofing services. Our team believes in quality workmanship,
                  and we go the extra mile to ensure customer{" "}
                </p>
