            ...
            <div className="col-xl-3 col-md-6">
              <div className="work-item">
                ...
                <div className="work-content">
                  ...
                  <p>
                    Our roofing process begins with meticulous planning to
                    ensure every project's success.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-xl-3 col-md-6">
              <div className="work-item">
                ...
                <div className="work-content">
                  ...
                  <p>
                    We provide a detailed estimate and schedule to keep our
            ...
            <div className="col-xl-3 col-md-6">
              <div className="work-item">
                ...
                <div className="work-content">
                  ...
                  <p>
                    Our skilled team efficiently installs the new roofing system
                    with precision.
                  </p>
                </div>
              </div>
            ...
            <div className="col-xl-3 col-md-6">
              <div className="work-item">
                ...
                <div className="work-content">
                  ...
                  <p>
                    Sit back and enjoy the benefits of our durable and quality
                    roofing solutions.
                  </p>
                </div>
              </div>
