...
import productsData from "../../components/json/product.json";
                ...
                <div className="col-xl-8">
                  <div className="services-details-wrap">
                    ...
                    <div className="services-details-content">
                      <h2 className="title">
                        Modified roofing beautiful wooden house with big windows
                      </h2>
                                ...
                                <li>
                                  <div className="services-process-item">
                                    ...
                                    <div className="content">
                                      ...
                                      <p>
                                        Creative analysis is important. It is
                          ...
                          <div className="col-lg-5">
                            <div className="benefits-content">
                              ...
                              <p>
                                ...
                                by injected humour, or randomised words whic
...
export async function getStaticPaths() {
  ...
  return {
    paths,
    fallback: false, // Set to false since we have static product pages
  };
}
